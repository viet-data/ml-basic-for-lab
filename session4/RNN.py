...
class DataReader:
    def __init__(self, data_path: str, batch_size: int):
        ...
        for data_id, line in enumerate(d_lines):
            ...
            label, doc_id, sentence_length = map(int, features[:3])
            vector = list(map(int, features[3].split()))
        ...
        self._senstence_lengths = np.array(self._sentence_lengths)
...
class RNN:
    ...
    def LSTM_layer(self, embeddings):
        ...
        print("Mask", mask)
        print("Lstm output",lstm_outputs)
...
def train_and_evaluate_RNN():
    ...
    with tf.Session() as sess:
        ...
        train_data_reader = DataReader(data_path = "datasets/w2v/20news_train_encoded.txt", batch_size=50)
        test_data_reader = DataReader(data_path="datasets/w2v/20news_test_encoded.txt", batch_size=50)
        ...
        while step < MAX_STEP:
            ...
            plabels_eval, loss_eval, _ = sess.run(
                                        ...
                                        feed_dict={rnn._data: train_data, rnn._labels:train_labels, 
                                                   rnn._sentence_lengths:train_sentence_lengths, rnn._final_tokens: train_final_token})
            ...
            if train_data_reader._batch_id == 0:
                ...
                while True:
                    ...
                    test_data, test_labels, test_sentence_lengths, test_final_token = next_test_batch
                    test_plabels_eval = sess.run(predicted_labels, feed_dict={rnn._data: test_data, rnn._labels:test_labels, 
                               rnn._sentence_lengths:test_sentence_lengths, rnn._final_tokens: test_final_token})
